...
public static class RolPermisoDAL
{
    public static async Task<IEnumerable<RolPermiso>> ObtenerRolPermisos(Guid rolId)
    {
    ...
    public static async Task<bool> AsignarPermisoRol(RolPermisoRequest request)
    {
        var db = new DapperDb(DB.GestorDB.POSTGRESQL, DB.Sistema.ENCUESTA, DB.BaseDeDatos.LOCAL);
        try
        {
    ...
    public static async Task<bool> RemoverPermisoRol(Guid rolId, Guid permisoId)
    {
        var db = new DapperDb(DB.GestorDB.POSTGRESQL, DB.Sistema.ENCUESTA, DB.BaseDeDatos.LOCAL);
        try
        {
