...
public static class OrganizacionDAL
{
    public static async Task<IEnumerable<Organizacion>> ObtenerOrganizaciones()
    {
    ...
    public static async Task<Organizacion?> ObtenerOrganizacionPorId(Guid id)
    {
        var db = new DapperDb(DB.GestorDB.POSTGRESQL, DB.Sistema.ENCUESTA, DB.BaseDeDatos.LOCAL);
        try
        {
    ...
    public static async Task<bool> CrearOrganizacion(OrganizacionRequest request)
    {
        var db = new DapperDb(DB.GestorDB.POSTGRESQL, DB.Sistema.ENCUESTA, DB.BaseDeDatos.LOCAL);
        try
        {
    ...
    public static async Task<bool> ActualizarOrganizacion(OrganizacionRequest request)
    {
        var db = new DapperDb(DB.GestorDB.POSTGRESQL, DB.Sistema.ENCUESTA, DB.BaseDeDatos.LOCAL);
        try
        {
    ...
    public static async Task<bool> EliminarOrganizacion(Guid id)
    {
        var db = new DapperDb(DB.GestorDB.POSTGRESQL, DB.Sistema.ENCUESTA, DB.BaseDeDatos.LOCAL);
        try
        {
            ...
            try
            {
                const string sql = "DELETE FROM organizacion WHERE id = @Id";
