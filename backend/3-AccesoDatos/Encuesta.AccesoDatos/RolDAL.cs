...
{
    public static async Task<IEnumerable<Rol>> ObtenerRoles(Guid organizacionId)
    {
    ...
    public static async Task<Rol?> ObtenerRolPorId(Guid id, Guid organizacionId)
    {
        var db = new DapperDb(DB.GestorDB.POSTGRESQL, DB.Sistema.ENCUESTA, DB.BaseDeDatos.LOCAL);
        try
        {
    ...
    public static async Task<bool> CrearRol(RolRequest request)
    {
        var db = new DapperDb(DB.GestorDB.POSTGRESQL, DB.Sistema.ENCUESTA, DB.BaseDeDatos.LOCAL);
        try
        {
    ...
    public static async Task<bool> ActualizarRol(RolRequest request)
    {
        var db = new DapperDb(DB.GestorDB.POSTGRESQL, DB.Sistema.ENCUESTA, DB.BaseDeDatos.LOCAL);
        try
        {
    ...
    public static async Task<bool> EliminarRol(Guid id, Guid organizacionId)
    {
        var db = new DapperDb(DB.GestorDB.POSTGRESQL, DB.Sistema.ENCUESTA, DB.BaseDeDatos.LOCAL);
        try
        {
