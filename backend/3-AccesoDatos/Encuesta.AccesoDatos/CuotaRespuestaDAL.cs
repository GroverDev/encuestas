...
public static class CuotaRespuestaDAL
{
    public static async Task<IEnumerable<CuotaRespuesta>> ObtenerCuotas(Guid encuestaId)
    {
    ...
    public static async Task<CuotaRespuesta?> ObtenerCuotaPorId(Guid id, Guid encuestaId)
    {
        var db = new DapperDb(DB.GestorDB.POSTGRESQL, DB.Sistema.ENCUESTA, DB.BaseDeDatos.LOCAL);
        try
        {
    ...
    public static async Task<bool> CrearCuota(CuotaRespuestaRequest request)
    {
        var db = new DapperDb(DB.GestorDB.POSTGRESQL, DB.Sistema.ENCUESTA, DB.BaseDeDatos.LOCAL);
        try
        {
    ...
    public static async Task<bool> ActualizarCuota(CuotaRespuestaRequest request)
    {
        var db = new DapperDb(DB.GestorDB.POSTGRESQL, DB.Sistema.ENCUESTA, DB.BaseDeDatos.LOCAL);
        try
        {
    ...
    public static async Task<bool> EliminarCuota(Guid id, Guid encuestaId)
    {
        var db = new DapperDb(DB.GestorDB.POSTGRESQL, DB.Sistema.ENCUESTA, DB.BaseDeDatos.LOCAL);
        try
        {
